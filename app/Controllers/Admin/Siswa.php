...
class Siswa extends BaseController
{
    ...
    public function update($id)
    {
        ...
        if (
            ...
            return redirect()->back()->with('error', 'Gagal update. NIS mungkin sudah digunakan atau form tidak lengkap.');
        }
        ...
        return redirect()->to($this->studentRedirectUrl((int) $this->request->getPost('id_kelas')))->with('success', 'Data siswa berhasil diperbarui.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to($this->studentRedirectUrl((int) ($siswa['id_kelas'] ?? 0)))->with('success', 'Data siswa & akun orang tua berhasil dihapus.');
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            if (
                ...
                return redirect()->back()->with('error', 'Gagal menyimpan. NIS mungkin sudah terdaftar atau form tidak lengkap.');
            }
            ...
            return redirect()->to($this->studentRedirectUrl((int) $siswaData['id_kelas']))->with('success', 'Data Siswa & Akun Orang Tua berhasil dibuat. Password login NIS: ' . $nis);
    ...
    public function resetPassword($id)
    {
        ...
        return redirect()->to($this->studentRedirectUrl((int) ($siswa['id_kelas'] ?? 0)))->with('success', 'Password siswa ' . $siswa['nama_siswa'] . ' berhasil direset ke ' . $displayPass . '.');
    }

    private function studentRedirectUrl(int $idKelas = 0): string
    {
        if ($idKelas > 0) {
            return base_url('admin/siswa?id_kelas=' . $idKelas);
        }

        return base_url('admin/siswa');
    }
}
